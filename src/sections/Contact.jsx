  ...
  return (
    <section id="contact" ref={sectionRef} className="relative z-10 py-20 md:py-28 px-6 md:px-20">
      <div className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        {/* Let's connect — left half */}
        <div className="w-full md:w-5/12">
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-sm px-10 py-10">
            ...
            <div className="flex items-center gap-8">
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="flex items-center justify-center w-14 h-14 rounded-xl border border-white/15 bg-white/5 hover:bg-white/15 hover:border-white/30 transition-all duration-200 text-white"
              >
        ...
        {/* Resume — full width */}
        <div className="w-full rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-sm overflow-hidden">
          ...
          <div className="border-t border-white/8 px-10 py-6 flex justify-center">
            <a
              href="/resume.pdf"
              download
              className="px-10 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-white font-semibold text-sm tracking-wide transition-all duration-200"
            >
              Download Resume
            </a>
          </div>
