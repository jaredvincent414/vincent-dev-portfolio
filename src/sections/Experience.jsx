...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-12 md:py-16 px-5 md:px-20">
      <TitleHeader title="Experience" sub="What I have done so far" />

      {/* ── DESKTOP layout (md+) ── */}
      <div className="hidden md:block relative mt-12 max-w-5xl mx-auto">
        ...
        <div
          ...
          style={{ background: "linear-gradient(to bottom, #a50044 0%, #3b82f6 60%, transparent 100%)" }}
        />
              ...
              <div key={card.title} className="relative flex items-center justify-center min-h-[140px]">
                ...
                <div className="w-1/2 pr-12 flex justify-end">
                  {isLeft ? (
                    <div className="exp-card w-full max-w-md rounded-2xl p-6
                                    ...
                                    shadow-[0_0_30px_rgba(165, 0, 68,0.08)] relative">
                      ...
                      <ul className="flex flex-col gap-3">
                        {card.responsibilities.map((r) => (
                          <li key={r} className="flex gap-2.5 text-white/90 text-base leading-relaxed">
                            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-grana-400 flex-none" />
                            {r}
                          </li>
                        ))}
                      </ul>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 z-10">
                  <div className="w-14 h-14 rounded-full border-2 border-white/25 bg-[#0b0f1e]
                                  ...
                                  shadow-[0_0_0_4px_rgba(165, 0, 68,0.12),0_0_20px_rgba(165, 0, 68,0.2)]">
                    <img src={card.logoPath} alt={card.company} loading="lazy" className="w-8 h-8 object-contain rounded-full" />
                  </div>
                </div>
                ...
                <div className="w-1/2 pl-12 flex justify-start">
                  {!isLeft ? (
                    ...
                    <p className="text-white/65 text-sm font-medium whitespace-nowrap self-center">
                      {card.date}
                    </p>
                  )}
                </div>
      ...
      {/* ── MOBILE layout (< md) ── */}
      <div className="md:hidden relative mt-10 pl-10">
        {/* Left timeline track */}
            ...
            <div key={card.title} className="relative">
              ...
              <div className="absolute -left-[34px] top-4 z-10">
                <div className="w-10 h-10 rounded-full border-2 border-white/25 bg-[#0b0f1e]
                                flex items-center justify-center
                                shadow-[0_0_0_3px_rgba(165, 0, 68,0.12),0_0_14px_rgba(165, 0, 68,0.2)]">
                  <img src={card.logoPath} alt={card.company} loading="lazy" className="w-6 h-6 object-contain rounded-full" />
                </div>
              </div>

              {/* Card — full width */}
              <div className="exp-card rounded-2xl p-5 bg-[#0d0d2b] border border-white/10
                              shadow-[0_0_24px_rgba(165, 0, 68,0.07)]">
